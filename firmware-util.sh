...
#where the stuff is
script_url="https://raw.githubusercontent.com/Cometia0/scripts/master"
...
$CURL -sLOJ ${script_url}firmware.sh
rc0=$?
$CURL -sLOJ ${script_url}functions.sh
rc1=$?
$CURL -sLOJ ${script_url}sources.sh
rc2=$?
